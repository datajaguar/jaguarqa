# Test create index performance

# Check starting time
######################
t1=`date +%s`
echo "Starting is t1: $t1 \n"
...
$JAGUAR_HOME/bin/jag -u admin -p jaguar -h $HOST:$PORT -e "create index index_v3 on db_mongo_jaguar.tab_400million(v3);"
