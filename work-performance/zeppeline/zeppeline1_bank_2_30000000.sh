...
#: Script Name: zeppeline1_bank_2_30000000.sh 
...
# nohup zeppeline1_bank_2_30000000.sh > zeppeline1_bank_2_30000000.sh.out &


# Need two system environments:
# JAGUAR_HOME and QA_HOME  

FILE=zeppeline1_bank_2_30000000
...
loginj < $QA_HOME/sql/zeppeline1_bank_createTable_2.sql 2>&1 | tee -a $logf
...
do
    ...
    loginj < $QA_HOME/sql/zeppeline1_bank_loadData_2.sql 
done
