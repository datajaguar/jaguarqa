...
# Script Name: Modify_monogDB_insert_tail.sh
...
#    echo "use jagdb"  > mongoDB_update_10000_700million_tail.sql
    echo "db.xaa700m_row.insert({uid: \"$line\", v1: '1118 Guyson ct',v2: 'Plesanton',v3: '94588'})" >> mongoDB_insert_10000_700million_tail.sql 
done
