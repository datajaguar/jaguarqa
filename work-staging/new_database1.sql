...
spool new_database1.out;


show tables;
createdb new_database1;
show database
use new_database1;
show tables;

create table new_database1.table1  ( key: uid char(32), value: v1 char(16), v2 char(16), v3 char(16) );

show tables;

# Test 1-2.  Delete table
###########################
desc new_database1.table1;
show tables;
desc new_database1.table1; 

# Test 2-1: Load a 10k row text file in foramt H:
#################################################
load $QA_HOME/data/10kLine.txt into new_database1.table1;

load $QA_HOME/data/10line.txt into new_database1.table1;


select * from new_database1.table1; where uid=Qdh3Cxi8EZcSV6Dm;

use test;
create table test.table1  ( key: uid char(32), value: v1 char(16), v2 char(16), v3 char(16) );

desc table test.table1;

load $QA_HOME/data/10line.txt into test.table1;


select count(*) from new_database1.table1;

select * from new_database1.table1 where uid=FQfbHNKNcgPORWNs;
select * from new_database1.table1  where v2=c3BRPlD1BsNsnAT3;
